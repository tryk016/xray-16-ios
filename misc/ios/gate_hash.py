...
IOS_ARTIFACT_INPUTS = (
    ...
    "misc/ios/run_gate_logged.sh",
    "misc/ios/test_run_gate_logged.py",
    "misc/ios/test_feedback.py",
    "misc/ios/test_feedback_catalog.json",
    "misc/ios/test_feedback_unittest.py",
    "misc/ios/test_test_feedback.py",
    "misc/ios/input.sh",
    "misc/ios/shot.sh",
    ...
    "misc/ios/archive_completed_artifacts.py",
    "misc/ios/test_archive_completed_artifacts.py",
    ...
    "misc/ios/ui_automation/devicectl_contract.py",
    "misc/ios/ui_automation/log_oracles.sh",
    "misc/ios/ui_automation/run.sh",
    ...
    "misc/ios/ui_automation/xctest_contract.py",
